...
public class LoanController {
  ...
  @Operation(summary = "Borrow a book (ADMIN only)", description = "Create a new loan for a member borrowing a book")
  @ApiResponses(value = {
  ...
  @Operation(summary = "Return a book (ADMIN only)", description = "Update the loan status to returned and increase the book stock")
  @ApiResponses(value = {
